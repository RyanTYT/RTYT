	...
	return (
		<div className={styles.bigContainer}>
			...
			<div className={styles.outside}>
				Ryan Tan Yan Tong, NUS, National University of Singapore,
				Business Analytics, Business Administration, Double Degree
				Programme, DDP, NUS Merit Scholarship
			</div>
			<div className={styles.contacts}>
				<div className={styles.container}>
					...
					<a href="https://www.linkedin.com/in/ryan-tan-yan-tong-b820121a3/">
						<img src="./icons/whiteLinkedin.svg" alt="Linkedin" />
					</a>
					<a href="mailto:ryan.tyt@u.nus.edu">
						<img src="./icons/whiteEmail.svg" alt="Email" />
                        <span>ryan.tyt@u.nus.edu</span>
					</a>
